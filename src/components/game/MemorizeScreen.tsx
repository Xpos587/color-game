    ...
    <>
      <div className="memo-timer" style={{ color: textColor }}>
        ...
        >
          ...
          <span id="timer-dec" className="memo-timer-dec">
            {decPart}
          </span>
        </span>
      </div>
...
export function MemorizeScreen({
  ...
  return (
    <div className="relative h-full w-full" style={{ backgroundColor: hsbToCss(targetHsb) }}>
      ...
      {/* Watermark */}
      <div
        className="memo-watermark"
        style={{
          color: textColor
            .replace("#fff", "rgba(255,255,255,0.5)")
            .replace("#000", "rgba(0,0,0,0.5)"),
        }}
      >
        Dialed.gg
      </div>
