...
function PersonIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      />
      <path
        d="M12.0011 13.25C8.60997 13.25 6.03711 15.2643 4.9836 18.1129C4.5748 19.2182 5.51944 20.25 6.69796 20.25H17.3043C18.4828 20.25 19.4274 19.2182 19.0186 18.1129C17.9651 15.2643 15.3923 13.25 12.0011 13.25Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
function UsersIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path
        d="M12 9.5C13.3807 9.5 14.5 8.38071 14.5 7C14.5 5.61929 13.3807 4.5 12 4.5C10.6193 4.5 9.5 5.61929 9.5 7C9.5 8.38071 10.6193 9.5 12 9.5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M4.5 11C5.60457 11 6.5 10.1046 6.5 9C6.5 7.89543 5.60457 7 4.5 7C3.39543 7 2.5 7.89543 2.5 9C2.5 10.1046 3.39543 11 4.5 11Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M19.5 11C20.6046 11 21.5 10.1046 21.5 9C21.5 7.89543 20.6046 7 19.5 7C18.3954 7 17.5 7.89543 17.5 9C17.5 10.1046 18.3954 11 19.5 11Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M8.5 19.25H15.5C16.4665 19.25 17.25 18.4665 17.25 17.5C17.25 14.6005 14.8995 12.25 12 12.25C9.1005 12.25 6.75 14.6005 6.75 17.5C6.75 18.4665 7.5335 19.25 8.5 19.25Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M3.75136 18.2498H2.50119C1.39662 18.2498 0.470354 17.3063 0.986733 16.3299C1.67862 15.0215 3.02859 14.0591 4.50136 13.812"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M20.25 18.2498H21.5C22.6046 18.2498 23.5308 17.3063 23.0145 16.3298C22.3227 15.0215 20.9728 14.0591 19.5 13.812"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function TrophyIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      />
      <path
        d="M2.67188 14.2992C3.11994 16.8673 4.55393 17.6952 7.002 16.7992C6.55393 14.2311 5.11995 13.4032 2.67188 14.2992Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IntroScreen({ mode, onModeChange, onPlay, sound }: IntroScreenProps) {
  ...
  return (
    <div ref={containerRef} className="relative flex h-full w-full flex-col bg-black">
      ...
      <button
        type="button"
        className="intro-trophy-mobile absolute z-20 flex items-center justify-center rounded-full text-white/50 transition-[transform,color] duration-150"
        style={{
      ...
      <div className="intro-body">
        <p>
          Humans can&apos;t reliably recall colors. This is a simple game to see how good (or bad)
          you are at&nbsp;it.
        </p>
      ...
      <div className="intro-mode-buttons absolute flex items-center">
        ...
        <button
          ...
          className="flex h-[64px] w-[64px] shrink-0 cursor-default items-center justify-center rounded-full bg-white text-black shadow-[0_2px_8px_rgba(0,0,0,0.15)] transition-[transform] duration-300 ease-out hover:scale-[1.04] active:scale-[0.94]"
        ...
        <ModeToggle
          mode={mode}
          onToggle={() => handleModeChange(mode === "easy" ? "hard" : "easy")}
        />

        {/* Leaderboard button — desktop only, hidden on mobile (shown above instead) */}
        <button
          type="button"
          className="hidden h-[64px] w-[64px] shrink-0 cursor-default items-center justify-center rounded-full text-[#808080] transition-[transform,color] duration-150 hover:scale-[1.08] hover:text-white active:scale-[0.95] md:flex"
          aria-label="High Scores"
          onMouseEnter={() => sound.hover()}
          onClick={() => sound.robotHighscores()}
        >
      ...
      >
        ...
        <a
          href="https://dialed.gg/privacy"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: "rgba(255,255,255,0.4)", textDecoration: "none", fontSize: "inherit" }}
        >
          Privacy
        </a>
        <span style={{ opacity: 0.4, margin: "0 2px" }}>·</span>
