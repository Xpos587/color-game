...
export function ColorSwatch({
  ...
  const scoreColor = playerRgb && luminance(playerRgb) > 0.45 ? "#000" : "#fff"

  return (
    <div
      className="anim-cell relative aspect-square w-full overflow-hidden"
    ...
    >
      ...
      <span className="swatch-score" style={{ color: scoreColor }}>
        {score.toFixed(2)}
      </span>
    </div>
  )
